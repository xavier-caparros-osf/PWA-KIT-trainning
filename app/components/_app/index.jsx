    ...
    useEffect(() => {
        ...
        const fetchStore = async () => {
            ...
            const res = await fetch(
                `${getAppOrigin()}/mobify/proxy/ocapi/s/RefArch/dw/shop/v20_4/stores?latitude=${
                    GEO_LOCATION.lat
                }&longitude=${GEO_LOCATION.long}&client_id=${client_id}`
            )
            if (res.ok) {
...
`
    ...
    const result = await fetch(
        `http://localhost:3000/mobify/proxy/ocapi/s/RefArch/dw/shop/v20_4/content/privacy-policy?client_id=${client_id}`
    )
